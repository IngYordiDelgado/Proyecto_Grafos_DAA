...
class Grafo:
    ...
    def remove_nodo(self, etiqueta_nodo):  # metodo para eliminar nodos en el grafo
        ...
        copia_aristas_entrantes = nodo.get_aristas_entrantes().copy()
        ...
        for arista in copia_aristas_salientes:
    ...
    def get_grado(self, etiqueta):
        if self.es_dirigido():
            ...
            grado = len(self.get_nodo(etiqueta).get_aristas_salientes()) / 2
        return grado

    def es_dirigido(self):  # parametro que regresa si el grafo es dirigido
...
if __name__ == "__main__":
    ...
    test_graph.add_nodo("a")
    test_graph.add_nodo("b")
    test_graph.add_nodo("c")
    test_graph.add_nodo("d")


    test_graph.add_arista("a", "c")
    test_graph.add_arista("d", "a")
    test_graph.add_arista("c", "b")
    test_graph.add_arista("b", "c")


    print(test_graph)
    print(len(test_graph.get_nodos()))
    print(len(test_graph.get_aristas()))
    print(test_graph)
    test_graph.remove_nodo("a")
    print(len(test_graph.get_nodos()))
    print(len(test_graph.get_aristas()))
    print(test_graph)
